...
Data da última revisão: 14 de julho de 2020
...
Parceiros de anúncios e outros serviços de terceiros podem usar cookies, scripts e/ou web beacons  para rastrear informações sobre as atividades dos visitantes nesse site, com intuito de mostrar anúncios e outras informações úteis. Tal rastreamento é feito diretamente por estes serviços de terceiros, através de seus próprios servidores, que têm suas próprias políticas de privacidade. A captura, posse, processamento, proteção e integral gestão destes dado são de resposabilidade destes. Este site não tem acesso ou controle sobre estes cookies, scripts e/ou web beacons que podem ser utilizados por terceiros. Acesse e entenda:

* [como desativar o uso de cookies do Google AdSense][googleAdsLink]
* [política de privacidade do Facebook][ppFacebook]
* [política de privacidade do Facebook, com explicações][ppFacebookExplained]
...
Os dados que estiverem sob nossa responsabilidade (tais como e-mail e nome para newsletter) são confidenciais e não serão vendidos, cedidos, locados, sublocados, emprestados ou  quaisquer outras modalidades, de forma total ou parcial, que representem o repasse dos seus dados, sob nenhuma hipotése (com exceção dos casos de ordens judiciais, os quais serão oportunamente analisados antes do devido cumprimento, se for o caso).
...
[ppFacebook]: https://www.facebook.com/about/privacy/update/printable
[ppFacebookExplained]: https://pt-br.facebook.com/privacy/explanation

[contactLink]: mailto:privacidade@programadoresbr.dev
